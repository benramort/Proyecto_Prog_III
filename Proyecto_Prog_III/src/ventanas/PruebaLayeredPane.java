 ...
 */
public class PruebaLayeredPane extends JPanel
    ...
    protected static ImageIcon createImageIcon(String path) {
        java.net.URL imgURL = PruebaLayeredPane.class.getResource(path);
        if (imgURL != null) {
    ...
    private static void createAndShowGUI() {
        ...
        JComponent newContentPane = new PruebaLayeredPane();
